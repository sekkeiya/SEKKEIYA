    ...
    <Box sx={{ width: '100%', flex: 1, p: { xs: 3, md: 5, lg: 8 }, boxSizing: 'border-box', overflowY: 'auto' }}>
      <Box sx={{ maxWidth: 1000, mx: 'auto' }}>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 8 }}>
          ...
          <Box sx={{ display: 'flex', gap: 2 }}>
            ...
            <Button 
              ...
              sx={{ 
                bgcolor: "#00BFFF", color: "#fff", borderRadius: 8, textTransform: 'none', fontWeight: 700, px: 3,
        ...
        <Box sx={{ 
          ...
          <ManageSearchRoundedIcon sx={{ fontSize: 56, color: "rgba(255,255,255,0.2)", mb: 2 }} />
          <Typography variant="subtitle1" sx={{ color: "#fff", fontWeight: 800, mb: 1 }}>
            リサーチデータがありません
          </Typography>
          <Typography variant="body2" sx={{ color: "rgba(255,255,255,0.5)", textAlign: 'center', lineHeight: 1.8 }}>
