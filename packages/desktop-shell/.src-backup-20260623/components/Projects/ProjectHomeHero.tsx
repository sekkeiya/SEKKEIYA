          ...
          <Box sx={{ width: "100%", minWidth: 0 }}>
            <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 2 }}>
              <Chip 
                label="プロジェクト"
                size="small" 
                sx={{ bgcolor: "rgba(255,255,255,0.1)", color: "#fff", fontWeight: 700, letterSpacing: 0.5 }}
              />
              <Chip 
                label="アクティブ" 
                size="small" 
            ...
            <Typography variant="h6" sx={{ color: "rgba(255,255,255,0.5)", maxWidth: 800, fontWeight: 400, lineHeight: 1.6, mb: 6 }}>
              {project.description || "プロジェクトのトップページです。"}
            </Typography>

            {/* Project Metadata & Quick Actions */}
            <Box sx={{ display: "flex", flexWrap: "wrap", gap: 3, alignItems: "center", mt: 4, pt: 3, borderTop: "1px solid rgba(255,255,255,0.1)" }}>
              <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                ...
                <Typography variant="body2" sx={{ color: "rgba(255,255,255,0.7)", fontWeight: 600, ml: 1 }}>
