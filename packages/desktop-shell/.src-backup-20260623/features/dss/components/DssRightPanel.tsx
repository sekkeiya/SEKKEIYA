  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, pb: 2 }}>
      ...
      <Box sx={{ width: '100%', aspectRatio: '4/3', bgcolor: 'rgba(0,0,0,0.2)', borderRadius: 2, border: '1px solid rgba(255,255,255,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'hidden' }}>
        {((versionsObj[selectedVersionId] && versionsObj[selectedVersionId].glbUrl) || (selectedVersionId === latestVersion && selectedItem.glbUrl)) ? (
          <RightPanelModelViewer 
            modelUrl={(versionsObj[selectedVersionId] && versionsObj[selectedVersionId].glbUrl) || selectedItem.glbUrl} 
