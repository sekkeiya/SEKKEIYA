...
const GridCell = React.memo(({ columnIndex, rowIndex, style, data }: any) => {
  const { items, selectedItemId, onSelectProject, onDoubleClickProject, badgeColor, columnCount, paddingLeft } = data;
...
export const DssProjectsGrid: React.FC<DssProjectsGridProps> = ({
  ...
  }, [items, selectedItemId, onSelectProject, onDoubleClickProject, badgeColor, columnCount, paddingLeft]);
