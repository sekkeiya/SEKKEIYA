...
import { saveRenderToLayout } from "@desktop/features/dsl/layout/api/layoutRendersApi";
import { DSI_CATEGORIES } from "@desktop/features/dsi/store/useDsiStore";
  ...
  const saveToLocalSekkeiya = useCallback(async (activeCards, pid) => {
    try {
      ...
      for (const card of activeCards) {
        const bytes = dataUrlToUint8Array(card.thumbnail);
        const ext = card.thumbnail.startsWith("data:image/jpeg") ? "jpg" : "png";
