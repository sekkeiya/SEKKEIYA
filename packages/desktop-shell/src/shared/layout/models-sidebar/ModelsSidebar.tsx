    ...
    <Box sx={{ mx: 1.5, mt: 0.5, mb: 1, p: 1, borderRadius: 2, bgcolor: 'light-dark(rgba(15,23,42,0.07), rgba(0,0,0,0.2))', border: '1px solid rgb(var(--brand-fg-rgb) / 0.06)' }}>
      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', px: 0.5, mb: 0.5 }}>
        ...
        <Tooltip title="フォルダを追加" placement="top">
          <IconButton size="small" onClick={() => addSourceViaDialog()} sx={{ color: 'rgb(var(--brand-fg-rgb) / 0.6)', '&:hover': { color: LOCAL_ACCENT } }}>
      ...
      <Typography sx={{ fontSize: 9, color: 'rgb(var(--brand-fg-rgb) / 0.3)', px: 0.5, mt: 0.5, lineHeight: 1.4 }}>
  ...
  return (
    <Box
      ...
      sx={{
        ...
        '&:hover': { bgcolor: active ? 'rgba(22,163,74,0.22)' : 'rgb(var(--brand-fg-rgb) / 0.05)' },
      }}
    >
      <FolderOpenRoundedIcon sx={{ fontSize: 12, flexShrink: 0, color: active ? '#16a34a' : 'rgb(var(--brand-fg-rgb) / 0.4)' }} />
