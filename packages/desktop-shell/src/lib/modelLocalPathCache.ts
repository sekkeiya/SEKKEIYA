// src/lib/modelLocalPathCache.ts
...
async function invokeGetModelLocalPath(modelId: string, ext: string): Promise<string | null> {
  const e = String(ext || "").toLowerCase();
  try {
    return await invoke<string | null>("get_model_local_path", {
