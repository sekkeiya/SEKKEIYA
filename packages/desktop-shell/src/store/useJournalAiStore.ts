...
export type WatchedScope = 'requirements' | 'workfiles' | 'models' | 'layout' | 'presents' | 'journal' | 'ai_drive' | 'library';
...
export const useJournalAiStore = create<JournalAiState>((set, get) => ({
  ...
  watchedScopes: ['requirements', 'workfiles', 'models', 'layout', 'presents', 'journal', 'library'], // Default project scopes
