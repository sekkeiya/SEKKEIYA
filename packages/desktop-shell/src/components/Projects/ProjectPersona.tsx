      ...
      <Box sx={{ maxWidth: 1000, mx: 'auto' }}>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 3 }}>
          <Box sx={{ width: 32, height: 32, borderRadius: '50%', bgcolor: 'rgba(250, 112, 154, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <AccountCircleRoundedIcon sx={{ color: "#fa709a", fontSize: 20 }} />
          </Box>
          <Typography variant="h6" sx={{ color: "#fff", fontWeight: 800 }}>対象ユーザーモデル</Typography>
        </Box>

        <Paper sx={{ p: 4, bgcolor: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 4 }}>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 4 }}>
            <Box>
              <Typography variant="overline" sx={{ color: "#fa709a", fontWeight: 800, letterSpacing: 1, display: 'block', mb: 0.5 }}>
                PERSONA PROFILE
              </Typography>
            ...
            <Box sx={{ display: 'flex', gap: 1 }}>
              ...
              <IconButton size="small" sx={{ color: 'rgba(255,255,255,0.4)', '&:hover': { color: '#f5576c' } }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, cursor: 'pointer', color: 'rgba(255,255,255,0.5)', '&:hover': { color: '#fff' } }}>
