      ...
      <Box sx={{ maxWidth: 1000, mx: 'auto' }}>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 8 }}>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            <Typography variant="caption" sx={{ color: "rgb(var(--brand-fg-rgb) / 0.6)", fontWeight: 600 }}>
              入力進捗: 0%
            </Typography>
            <Button 
              variant="outlined" 
        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
          ...
          <Paper sx={{ p: 4, bgcolor: "rgb(var(--brand-fg-rgb) / 0.02)", border: "1px solid rgb(var(--brand-fg-rgb) / 0.08)", borderRadius: 4 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 4 }}>
              ...
              <Typography variant="subtitle1" sx={{ color: "var(--brand-fg)", fontWeight: 800 }}>コア・コンセプト</Typography>
            </Box>
            <Typography variant="h5" sx={{ color: "var(--brand-fg)", fontWeight: 800, mb: 1 }}>
              コンセプト名が設定されていません
            </Typography>
          ...
          <Paper sx={{ p: 4, bgcolor: "rgb(var(--brand-fg-rgb) / 0.02)", border: "1px solid rgb(var(--brand-fg-rgb) / 0.08)", borderRadius: 4 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 6 }}>
              ...
              <Typography variant="subtitle1" sx={{ color: "var(--brand-fg)", fontWeight: 800 }}>KPI・期待効果</Typography>
            </Box>
            <Typography variant="body2" sx={{ color: "rgb(var(--brand-fg-rgb) / 0.4)", textAlign: 'center' }}>
              定義されたKPIはありません。
            </Typography>
          </Paper>
          ...
          <Paper sx={{ p: 4, bgcolor: "rgb(var(--brand-fg-rgb) / 0.02)", border: "1px solid rgb(var(--brand-fg-rgb) / 0.08)", borderRadius: 4 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 6 }}>
              ...
              <Typography variant="subtitle1" sx={{ color: "var(--brand-fg)", fontWeight: 800 }}>課題マトリクス・調査事項</Typography>
            </Box>
            <Typography variant="body2" sx={{ color: "rgb(var(--brand-fg-rgb) / 0.4)", textAlign: 'center' }}>
              定義された課題はありません。
            </Typography>
