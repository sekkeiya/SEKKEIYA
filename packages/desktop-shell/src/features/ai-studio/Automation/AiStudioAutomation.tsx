  ...
  return (
    <Box sx={{ display: 'flex', height: '100%', minHeight: 0, width: '100%' }}>
      ...
      {cap ? (
        ...
        <Box sx={{ flex: 1, minWidth: 0, height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', bgcolor: 'var(--brand-surface)' }}>
          <Stack alignItems="center" spacing={2} sx={{ textAlign: 'center', maxWidth: 380, px: 3 }}>
            <AccountTreeRoundedIcon sx={{ fontSize: 52, color: 'light-dark(rgba(71,14,160,0.5), rgba(196,163,247,0.5))' }} />
            <Typography sx={{ fontSize: 18, fontWeight: 800, color: 'var(--brand-fg)' }}>AIの受け答えガイド</Typography>
            <Typography sx={{ fontSize: 13, color: 'rgb(var(--brand-fg-rgb) / 0.55)', lineHeight: 1.7 }}>
