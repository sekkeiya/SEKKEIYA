...
export default function ProjectBoardHero({ board, metrics = {} }) {
  ...
  const line = BRAND.line || "rgba(255,255,255,0.10)";
              ...
              {phaseLabel && (
                <Chip
                  ...
                  sx={{
                    px: 0.5,
                    fontWeight: 700,
                    bgcolor: alpha(BRAND.primary || theme.palette.primary.main, 0.2),
                    borderColor: alpha(BRAND.primary || theme.palette.primary.main, 0.3),
                    border: "1px solid",
                    color: fg
                  }}
                />
