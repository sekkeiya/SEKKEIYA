...
export default function FollowingPage() {
  ...
  return (
    <Box sx={{ p: 4, color: "white", flex: 1, overflowY: "auto" }}>
      <Typography variant="h4" fontWeight="bold" gutterBottom>フォロー管理</Typography>
      <Typography variant="body1" sx={{ color: "rgba(255,255,255,0.7)", mb: 4 }}>
        あなたがプロジェクト等でフォローしているユーザーの一覧です。
      </Typography>
      ...
      {loading ? (
        ...
        <Typography sx={{ color: "rgba(255,255,255,0.5)" }}>フォローしているユーザーはいません</Typography>
      ) : (
          ...
          {filtered.map(u => (
            ...
            >
              <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                ...
                <Box>
                  <Typography variant="body1" fontWeight="bold">{u.name || "名称未設定ユーザー"}</Typography>
